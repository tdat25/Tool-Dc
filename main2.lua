-- 🛡️ Username
local input = gg.prompt({"🔐 Nhập Gmail Của Mày:"}, nil, {"text"})
if not input then return end
local username = input[1]:lower()

-- 🌐 Load tên user
local url = "https://raw.githubusercontent.com/tdat25/Tool-Dc/main/usersV2.lua"
...
-- 🚀 Load main script
local scriptUrl = "https://raw.githubusercontent.com/tdat25/Tool-Dc/main/tdatV2.lua"
